...
To use this library, you need WAGO PFC firmware SDK and associated libraries

Ensure that you have access to the required headers and libraries by referring
